"""
ScreenApp MCP Server - Complete Working Version
Based on proven Dify MCP pattern
"""
...
SCREENAPP_API_BASE_URL = "https://api.screenapp.io"
SCREENAPP_API_KEY = os.getenv("SCREENAPP_API_KEY", "")

app = FastAPI(
    title="ScreenApp MCP Server",
    description="MCP server for ScreenApp recordings and AI analysis",
    version="1.0.0"
)
...
TOOLS = [
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                "team_id": {"type": "string", "description": "The team ID"},
                "limit": {"type": "number", "description": "Number of recordings (default: 20)", "default": 20},
    ...
    {
        "name": "get_recording",
        "description": "Get detailed information about a specific recording including transcript",
        "inputSchema": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "created_after": {"type": "string", "description": "Filter by date (ISO 8601)"},
                "created_before": {"type": "string", "description": "Filter by date (ISO 8601)"}
            },
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "file_ids": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "Optional specific file IDs"
                }
            },
